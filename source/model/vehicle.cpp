...
btRigidBody& Vehicle::getFixedBody()
{
...
// ============================================================================
Vehicle::Vehicle(btRigidBody* chassis, btVehicleRaycaster* raycaster,
               BikeModel *bike)
...
//
btWheelInfo& Vehicle::addWheel(const btVector3& connectionPointCS,
...
// ----------------------------------------------------------------------------
const btTransform& Vehicle::getWheelTransformWS( int wheelIndex ) const
{
...
// ----------------------------------------------------------------------------
void Vehicle::updateWheelTransform(int wheelIndex, bool interpolatedTransform)
{
...
// ----------------------------------------------------------------------------
void Vehicle::updateWheelTransformsWS(btWheelInfo& wheel,
...
/** 
 */
btScalar Vehicle::rayCast(unsigned int index)
{
...
void Vehicle::updateVehicle( btScalar step )
{
	...
	float f = -m_bikeModel->getRigidBody()->getLinearVelocity().length() //Speed
            * 0.0 /*downward impulse */;
...
// ----------------------------------------------------------------------------
void Vehicle::setSteeringValue(btScalar steering, int wheel)
{
...
// ----------------------------------------------------------------------------
btScalar Vehicle::getSteeringValue(int wheel) const
{
    return getWheelInfo(wheel).m_steering;
}

// ----------------------------------------------------------------------------
void Vehicle::applyEngineForce(btScalar force, int wheel)
{
    btAssert(wheel>=0 && wheel < getNumWheels());
    btWheelInfo& wheelInfo = getWheelInfo(wheel);
...
// ----------------------------------------------------------------------------
const btWheelInfo& Vehicle::getWheelInfo(int index) const
{
...
// ----------------------------------------------------------------------------
btWheelInfo& Vehicle::getWheelInfo(int index)
{
    btAssert((index >= 0) && (index < getNumWheels()));
...
// ----------------------------------------------------------------------------
void Vehicle::setAllBrakes(btScalar brake)
{
    for(int i=0; i<getNumWheels(); i++)
...
// ----------------------------------------------------------------------------
void Vehicle::updateSuspension(btScalar deltaTime)
{
    (void)deltaTime;
    ...
    for (int w_it=0; w_it<getNumWheels(); w_it++)
    {
        ...
        //if(m_bikeModel->getKartProperties()->getExpSpringResponse())
...
// ----------------------------------------------------------------------------
btScalar Vehicle::calcRollingFriction(btWheelContactPoint& contactPoint)
{
 ...
 */
void Vehicle::setSliding(bool active)
{
 ...
 */
void Vehicle::instantSpeedIncreaseTo(float speed)
{
...
void Vehicle::capSpeed(float max_speed)
{
...
btScalar Vehicle::rayCast(btWheelInfo& wheel, const btVector3& ray)
{
    updateWheelTransformsWS( wheel,false);
